...
public class MoverTeclado extends JComponent {
    ...
    public static void main(String[] args) throws Exception {
        JFrame jf = new JFrame("MoverTecladoSnake");
        ...
        MoverTeclado moverTeclado = new MoverTeclado();
        jf.getContentPane().add(moverTeclado);
        jf.pack();
        jf.setVisible(true);
        moverTeclado.cicloPrincipalJuego();
    }
}
